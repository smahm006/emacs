...
#+begin_src emacs-lisp
  (use-package visual-replace
    ...
    :bind ([remap query-replace] . my/visual-query-replace))
  ...
  (with-eval-after-load "python"
    (define-key python-mode-map (kbd "C-c x") 'hydra-python/body))
#+end_src
** Linguistics
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load "c-mode"
	(define-key c-mode-map (kbd "C-c x") 'hydra-c-cpp/body))
  (with-eval-after-load "c-mode"
	(define-key c++-ts-mode-map (kbd "C-c x") 'hydra-c-cpp/body))
#+end_src
** Go
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load "go-mode"
	(define-key go-mode-map (kbd "C-c x") 'hydra-go/body))
#+end_src
** Rust
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load "rust-mode"
    (define-key rust-mode-map (kbd "C-c x") 'hydra-rust/body))
#+end_src
** Bash
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load "sh-script"
	(define-key sh-mode-map (kbd "C-c x") 'hydra-sh/body))
#+end_src
