...
- [[#user-development][User Development]]
  ...
  - [[#syntax-and-documentation][Syntax and Documentation]]
  - [[#debugging][Debugging]]
  - [[#snippets][Snippets]]
...
#+begin_src emacs-lisp
  (use-package emacs
    ...
    (defvar smahm006/toggle-map (make-sparse-keymap) "key-map for toggle commands")
    ...
    (defvar smahm006/debug-map (make-sparse-keymap) "key-map for debugginng commands")
    :config
    ...
    (define-key mode-specific-map (kbd "t") (cons "toggle" smahm006/toggle-map))
    ...
    (define-key mode-specific-map (kbd "d") (cons "debugging" smahm006/debug-map)))
#+end_src
** Modes
#+begin_src emacs-lisp
