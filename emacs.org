...
#+end_src
** Packages
To manage packages, I use the built-in use-package system.
*** Package Configuration
To manage the package configurations with use-package, we add some required package repositories
#+begin_src emacs-lisp
...
#+end_src
#+begin_src text
;; smahm006-org.el - Configures Org mode for structured note-taking, task management, and agenda organization.
;; Copyright (C) 2023-2025 Sohaib Mahmood
;; Homepage: https://github.com/smahm006/emacs
;; Code:
#+end_src
...
#+end_src
#+begin_src text
;; smahm006-ui.el - Defines visual elements and layout settings to enhance the Emacs UI.
;; Copyright (C) 2023-2025 Sohaib Mahmood
;; Homepage: https://github.com/smahm006/emacs
;; Code:
#+end_src
...
(use-package emacs
  ...
  ;; Cursor
  (cursor-type t)                                      ; Default block shaped cursor
...
(use-package dashboard
  ...
  :custom
  (dashboard-banner-logo-title "بِسْمِ اللّٰہِ الرَّحْمٰنِ الرَّحِیْم")
  ...
  :config
  (custom-set-faces
   '(dashboard-banner-logo-title ((t (:inherit font-lock-keyword-face :height 3.0 :width wide))))))
#+end_src
** Line Guides
...
#+end_src
#+begin_src text
;; smahm006-ux.el - Enhances usability with minibuffer completion, window, buffer, and file management improvements.
;; Copyright (C) 2023-2025 Sohaib Mahmood
;; Homepage: https://github.com/smahm006/emacs
;; Code:
#+end_src
...
#+end_src
#+begin_src text
;; smahm006-editing.el - Enhances text editing with structural manipulation, navigation, and undo/redo improvements.
;; Copyright (C) 2023-2025 Sohaib Mahmood
;; Homepage: https://github.com/smahm006/emacs
;; Code:
#+end_src
...
(use-package corfu
  ...
  (corfu-quit-at-boundary 'separator) ; Quit auto complete at completion boundary
  ...
  (corfu-separator 32)                ; Use space as the default corfu separator
...
#+end_src
#+begin_src text
;; smahm005-development.el - Provides tools for coding, debugging, version control, and remote access.
;; Copyright (C) 2023-2025 Sohaib Mahmood
;; Homepage: https://github.com/smahm006/emacs
;; Code:
#+end_src
...
#+end_src
#+begin_src text
;; smahm006-languages.el -  Configures support for various programming, scripting, and markup languages.
;; Copyright (C) 2023-2025 Sohaib Mahmood
;; Homepage: https://github.com/smahm006/emacs
;; Code:
#+end_src
...
#+end_src
**** go snippets
#+begin_src emacs-lisp :tangle snippets/go.eld :mkdirp yes
go-mode go-ts-mode
(imp "import " q)
(impn "import (" n> q n ")")
(pf "fmt.Printf("q")")
