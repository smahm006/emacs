...
- [[#editing][Editing]]
  ...
  - [[#undo--redo][Undo & Redo]]
  - [[#privileged-editing][Privileged Editing]]
...
* User Experience
:PROPERTIES:
:header-args+: :tangle lisp/smahm006-ux.el
:END:
** UX Defaults
#+begin_src emacs-lisp :tangle init.el
  (require 'smahm006-ux)
#+end_src
#+begin_src emacs-lisp :noweb yes
<<header(name="smahm006-ux.el", description="User Experience customizations for windows, buffers and files")>>
#+end_src
#+begin_src emacs-lisp
  (use-package emacs
    :ensure nil
...
#+begin_src emacs-lisp
  (use-package ibuffer
    ...
    (([remap kill-buffer] . kill-current-buffer)
     ("C-B" . smahm006/switch-to-previous-buffer)
